...
class Calculadora extends HTMLElement {
    ...
    connectedCallback() {
        ...
        if (btnSumar) btnSumar.addEventListener('click', () => this.operar('sumar'));
        if (btnRestar) btnRestar.addEventListener('click', () => this.operar('restar'));
        if (btnMultiplicar) btnMultiplicar.addEventListener('click', () => this.operar('multiplicar'));
        if (btnDividir) btnDividir.addEventListener('click', () => this.operar('dividir'));
    }
