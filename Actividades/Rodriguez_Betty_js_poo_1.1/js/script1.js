...
document.getElementById('incidente-form').addEventListener('submit', agregarIncidente);
...
function editarAlumno(id) {
    ...
    document.getElementById('contactoEmergencia').value = alumno.contactoEmergencia;

    document.getElementById('actualizar-button').style.display = 'block';
    document.getElementById('alumno-form button[type="submit"]').style.display = 'none';
}
...
function actualizarAlumno() {
    ...
    const alumnoActualizado = new Alumno(idActual, nombre, edad, curso, contactoEmergencia);

    alumnos[indiceAlumno] = alumnoActualizado;
    renderizarAlumnos();

    document.getElementById('actualizar-button').style.display = 'none';
    document.getElementById('alumno-form button[type="submit"]').style.display = 'block';
    document.getElementById('alumno-form').reset();
    idActual = null;
}
...
function renderizarIncidentes() {
    ...
    incidentes.forEach(incidente => {
        ...
        deleteButton.classList.add('btn', 'btn-danger', 'btn-sm');
        deleteButton.textContent = 'Eliminar';
        deleteButton.addEventListener('click', () => eliminarIncidente(incidente.id));
